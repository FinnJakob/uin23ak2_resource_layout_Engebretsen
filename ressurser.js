...
function renderHTML() {
    ...
    document.querySelector("#btn_html").classList.add("active")
    document.querySelector("#btn_css").classList.remove("active")
    document.querySelector("#btn_js").classList.remove("active")
    document.querySelector("#btn_react").classList.remove("active")
    document.querySelector("#btn_sanity").classList.remove("active")
    }
    ...
    document.querySelector("#info").innerHTML = rSrcHTML
    document.querySelector("#btn_css").classList.add("active")
    document.querySelector("#btn_js").classList.remove("active")
    document.querySelector("#btn_react").classList.remove("active")
    document.querySelector("#btn_sanity").classList.remove("active")
    document.querySelector("#btn_html").classList.remove("active")
    }
    ...
    document.querySelector("#info").innerHTML = rSrcHTML
    document.querySelector("#btn_js").classList.add("active")
    document.querySelector("#btn_react").classList.remove("active")
    document.querySelector("#btn_sanity").classList.remove("active")
    document.querySelector("#btn_html").classList.remove("active")
    document.querySelector("#btn_css").classList.remove("active")
    ...
    document.querySelector("#info").innerHTML = rSrcHTML
    document.querySelector("#btn_react").classList.add("active")
    document.querySelector("#btn_sanity").classList.remove("active")
    document.querySelector("#btn_html").classList.remove("active")
    document.querySelector("#btn_css").classList.remove("active")
    document.querySelector("#btn_js").classList.remove("active")
    ...
    document.querySelector("#info").innerHTML = rSrcHTML
    document.querySelector("#btn_sanity").classList.add("active")
    document.querySelector("#btn_html").classList.remove("active")
    document.querySelector("#btn_css").classList.remove("active")
    document.querySelector("#btn_js").classList.remove("active")
    document.querySelector("#btn_react").classList.remove("active")
